...
_RIASEC_KW = {
    'R': ['实验', '操作', '动手', '制作', '修理', '建造', '工具', '机械', '组装'],
    'I': ['研究', '分析', '探索', '思考', '科学', '理论', '发现', '推理', '逻辑', '钻研'],
    'A': ['艺术', '设计', '创作', '音乐', '绘画', '写作', '创意', '想象', '表达'],
    'S': ['帮助', '教育', '服务', '社会', '志愿', '照顾', '辅导', '贡献', '有意义', '助人'],
    'E': ['管理', '领导', '组织', '说服', '商业', '销售', '竞争', '演讲', '决策'],
    'C': ['规范', '数据', '整理', '细节', '会计', '统计', '记录', '条理', '规则'],
}
_VALUES_KW = {
    '社会贡献': ['帮助', '贡献', '社会', '有意义', '服务', '助人'],
    '个人成长': ['成长', '学习', '发展', '进步', '探索', '提升'],
    '工作稳定': ['稳定', '安全', '保障'],
    '薪资水平': ['薪资', '工资', '收入', '待遇'],
}
_REGIONS = ['广东', '广州', '深圳', '北京', '上海', '浙江', '江苏', '四川', '湖北']
